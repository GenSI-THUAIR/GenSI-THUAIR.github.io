...
function transformElegantRouteToVueRoute(
  ...
  function isFirstLevelRoute(item: ElegantConstRoute) {
    // 特殊处理：portal路由虽然包含下划线，但应该被视为单层路由
    if (item.name.startsWith('portal_')) {
      return true;
    }
...
const routeMap: RouteMap = {
  ...
  "portal": "/portal",
  "portal_about": "/portal/about",
  "portal_article": "/portal/article",
  "portal_contact": "/portal/contact",
  "portal_home": "/portal_home",
  "portal_news": "/portal/news",
  "portal_postdetail": "/portal/postdetail",
  "portal_posts": "/portal/blog",
  "portal_publications": "/portal/publications",
  "portal_research": "/portal/research",
